...
export async function runResearch(
  ...
  try {
    ...
    // Fire the lesson webhook to Daylila (best-effort, non-blocking) — the
    // briefing's other companion (Lesson + Lab), the mirror of the day-map.
    // Lands here so BOTH the cron and the manual "Run Now" path fire it.
    try {
